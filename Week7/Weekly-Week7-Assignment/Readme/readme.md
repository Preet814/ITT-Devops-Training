...
>> aws ecr get-login-password --region ap-south-1 | docker login --username AWS --password-stdin 867344449786.dkr.ecr.ap-south-1.amazonaws.com

>> docker tag new_dotnet_image:latest 867344449786.dkr.ecr.ap-south-1.amazonaws.com/new_dotnet_image:latest

>> docker push 867344449786.dkr.ecr.ap-south-1.amazonaws.com/new_dotnet_image:latest
...
Now run http://127.0.0.1:42047 on browser and check:
